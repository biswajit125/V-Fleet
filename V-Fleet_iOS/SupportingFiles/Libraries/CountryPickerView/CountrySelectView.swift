...
extension tableViewDelegate : UITableViewDelegate{
    ...
    func getCountry(forLocale localeId:String) -> [String:Any]?{
       
         for country in self.searchCountrys{
             if let countryLocale = country["locale"] as? String{
                 if countryLocale.lowercased() == localeId.lowercased(){
                     return country
                 }
             }
         }
     ...
     func getCountry(forCode code:String) -> [String:Any]?{
         
         for country in self.searchCountrys{
             if let countryCode = country["code"] as? String{
